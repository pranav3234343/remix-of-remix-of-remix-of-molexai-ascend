(function(){
  ...
  document.querySelectorAll('footer').forEach(footer=>{
    ...
    panel.innerHTML=`
      ...
      <div class="footer-contact-grid">
        ...
        <div class="footer-contact-item"><div class="footer-contact-label">Email</div><div class="footer-contact-value"><a href="mailto:hello@molexai.app">hello@molexai.app</a></div></div>
      </div>`;
  ...
  (function(){
    ...
    const cardsByPage={
      ...
      'press.html':['Resources','Everything press needs in one place',[['🖼️','Brand Kit','Logos, color tokens and product screenshots.'],['📄','Fact Sheet','Company at a glance — funding, team, traction.'],['🎙️','Founder Quotes','Pre-cleared quotes for fast-turnaround stories.'],['📬','Contact','Reach press@molexai.app for interviews and embargoes.']]],
